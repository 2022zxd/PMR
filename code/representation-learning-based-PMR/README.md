This folder contains part of the code we used of the code representation learning model. The complete code can be viewed at the following related links:
